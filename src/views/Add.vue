    ...
    <div class="max-w-screen-2xl mx-auto">
      <div class="p-4 lg:p-8">
        ...
        <p  v-if="!isStorySent" class="text-2xl font-light mb-10 max-w-4xl">
          Cuvintele îi poveștile vindecă și dau putere. Îți mulțumim că ni te-ai alăturat printr-un simplu click.
          Orice mesaj ne ajută și să mergem mai departe la bine și la rău, împreună.
          Transmite un mesaj de încurajare și de solidaritate către comunitatea LGBTQIA+ anonim sau semnat pentru a le da curaj.
        </p>
